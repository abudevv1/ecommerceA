...
ALTER TABLE `categories` ADD FOREIGN KEY (`perent_id`) REFERENCES `categories` (`id`); ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `attributes` ADD FOREIGN KEY (`attribute_id`) REFERENCES `attributes` (`id`);
...
ALTER TABLE `order` ADD FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`);

ALTER TABLE `order` ADD FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

ALTER TABLE `order` ADD FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);
